...
public class CircleProgressView extends View {
    ...
    //type
    private int type = 0;//0:动画不重复 1：动画重复
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PointF startPoint = calcArcEndPointXY(mWidth / 2, mHeight / 2, mWidth / 2 - 10, 360 * progress / max, angle);
        if (type == 0) {
    ...
    public void startAnimation(int start, int current, int duration, int repeatCount) {
