...
import com.bm.fusionworker.model.beans.ChargingGunBeans;
...
import com.bm.fusionworker.model.interfaces.ChargeOrderDetailView;
import com.bm.fusionworker.presenter.ChargeOrderDetailsPresenter;
import com.bm.fusionworker.utils.Tools;
import com.bm.fusionworker.weights.ChargeFeeDialog;
...
//            rgChooseGun.setOnCheckedChangeListener(this);
            for (int i = 0; i < scanChargeInfo.getChargingGunBeans().size(); i++) {
                ...
                if (chargingGunBeans.getGunStatus() == 1) {
                    ...
                    tvGunStatus.setTextColor(getResources().getColor(R.color.green));
                    ...
                    tvGunStatus.setTextColor(getResources().getColor(R.color.yellow));
