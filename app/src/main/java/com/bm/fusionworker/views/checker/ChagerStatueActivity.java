...
import com.bm.fusionworker.model.beans.HomeChargeOrderBean;
import com.bm.fusionworker.model.beans.PayInfoBean;
import com.bm.fusionworker.model.interfaces.ChargerStatueView;
import com.bm.fusionworker.presenter.ChargeStatuePresenter;
import com.bm.fusionworker.utils.Tools;
import com.bm.fusionworker.weights.CheckChargeFailDialog;
import com.bm.fusionworker.weights.CheckStatueLoadingView;
...
import com.bm.fusionworker.weights.TimerService;
...
//            }
            ...
            progressView.startAnimation(0, 100, 1000,1);
            if (bean.isStop == 1) {
                Log.e("yzh", "isStop");
//                timerService.cancelTimerHour();
